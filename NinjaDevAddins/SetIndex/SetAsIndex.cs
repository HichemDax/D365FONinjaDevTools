...
using System.Linq;
using D365FONinjaDevAddins.Kernel;
    ...
    public class SetAsIndex : DesignerMenuBase
    {
        ...
        public override void OnClick(AddinDesignerEventArgs e)
        {
            try
            {
                ...
                var source =
                    $@"public static {axTable.Name} findBy{field.Name} ({field.ExtendedDataType} _{LocalUtils
                ...
                {{
                    ...
                    select firstonly {LocalUtils.toCamelCase(axTable.Name)} where {LocalUtils.toCamelCase(axTable.Name)}.{field
                        .Name} == _{LocalUtils.toCamelCase(field.Name)};
        ...
        {
            get { return AddinResources.SetAsIndex; }
        }
